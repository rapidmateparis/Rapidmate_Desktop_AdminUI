...
import HomeAddFaqModal from '../WebsiteCommonPages/HomeAddFaqModal';
...
const HomeFaqSection = () => {
  ...
  return (
    <>
      ...
      <section className="adminManage-LanguagesSec">
        <div className="container">
          <div className="adminAll-vehicleHeadMainCard">
            <h2 className="adminAll-usersTitleText">FAQ Section</h2>
                ...
                <div>
                  <Table striped bordered hover>
                    ...
                    <tbody>
                      <tr>
                        <td>1</td>
                        <td>What services does your app provide?</td>
                        <td>Lorem ipsum dolor sit amet consectetur. Eget viverra volutpat a pellentesque.</td>
                        <td>
                          <div>
      ...
      <HomeAddFaqModal show={showModal} handleClose={handleCloseModal} />
    </>
  );
};
